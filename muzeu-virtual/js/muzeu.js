...
function scrieURL(){
  let u = 'muzeu.html?raion=' + encodeURIComponent(raionCurent);
...
(async function start(){
  try{ await incarcaDate(); }
    ...
    if(p) p.innerHTML = '<div class="car-gol"><div class="car-gol-paspartu"><p class="car-gol-rand1">Nu s-au putut încărca datele muzeului.</p><p class="car-gol-rand2">Verifică data/obiecte.json și data/raioane.json.</p></div></div>';
    throw e;
  }
