...
function draw() 
{
  ...
  if (result != null) 
  {
    ...
    resultP.style("background-color", "#FACF5A");
    resultP.style("margin", "25px 500px");
    resultP.style("border-radius", "30px");

    if (result == "tie") 
    {
      resultP.style("color", "#FF5959");;
      resultP.html("Egalitate!");
    } 
    else 
    {
      result == "X" ? resultP.style("color", "#FF5959") : resultP.style("color", "#FF5959");
